...
public class infixConvertor extends JFrame {
        ...
        ConvertToPrefix.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(temp.toString().equals("true")){
                    ...
                    if(JOptionPane.showConfirmDialog(frame,"Wrong Input, please use only infix equations","ERROR",JOptionPane.CANCEL_OPTION)==JOptionPane.CANCEL_OPTION) {
