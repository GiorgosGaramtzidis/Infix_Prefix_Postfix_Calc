...
public class postfixConvertor extends JFrame{
        ...
        convertToInfixButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(temp.equals("true")){
                    ...
                    if(JOptionPane.showConfirmDialog(frame,"Wrong Input, please use only postfix equations","ERROR",JOptionPane.CANCEL_OPTION)==JOptionPane.CANCEL_OPTION) {
